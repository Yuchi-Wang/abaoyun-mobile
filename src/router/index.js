  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: _resolve('product/faceRecognition'),
        name: 'faceRecognition'
      },
      {
        path: '/voice-verification',
        component: _resolve('product/voiceVerification'),
        name: 'voiceVerification'
      },
      {
        path: '/voice-to-words',
        component: _resolve('product/voiceToWords'),
        name: 'voiceToWords'
      },
      {
        path: '/voice-dictation',
        component: _resolve('product/vocieDictation'),
        name: 'vocieDictation'
      },
      {
        path: '/service',
      ...
      {
        path: '/exchange-code',
        component: _resolve('user/exchangeCode'),
        name: 'exchangeCode'
      }
    ]
  }
